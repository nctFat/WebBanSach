...
<asp:Content ID="Content1" ContentPlaceHolderID="NoiDung" runat="server">
    ...
    <asp:GridView ID="gvSach" runat="server" CssClass="table table-bordered mt-2" AutoGenerateColumns="False"
        ...
        <Columns>
            ...
            <asp:BoundField DataField="Dongia" HeaderText="Đơn giá" DataFormatString="{0: #,##0} VNĐ" SortExpression="Dongia" />
            <asp:ImageField DataImageUrlField="hinh" DataImageUrlFormatString="bia_sach/{0}" HeaderText="Hình"  ReadOnly="true" SortExpression="Hinh" />
